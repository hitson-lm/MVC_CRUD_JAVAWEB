...
public class actualizarEmpleado extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String nom = request.getParameter("txtNombre2"); //almacenamos en la variable, los datos ingresados por el formulario.
            ...
            // para actualizar llamamos a nuestro metodo de "actualizarEmpleado(Empleado e)"
